1. Save bam file to your bin subdirectory within SPAdes-3.11.1
2. Execute the file with: bash multi_kmer.sh
3. You will be prompted to type in your file name. Note: you cannot use tab to prepopulate your file name, so it may be beneficial to rename your files prior to running them
